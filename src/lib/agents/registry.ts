...
export const COMPANY_AGENTS: Readonly<Record<CompanyAgentId, CompanyAgentDefinition>> = {
  ...
  video_creator: agent("video_creator", "Short-form Video Creator", "Create truthful, high-retention vertical videos for TikTok and Instagram Reels.", "stage", ["product_facts.read", "content.read", "brand_assets.read", "video.brief.write", "video.render.local"], ["facts:approved", "artifacts:content", "assets:licensed", "artifacts:video", "render:local"], ["read", "draft", "write_safe"], 12, 20, 1_000_000),
